// Global variables
        ...
        // Lấy dữ liệu từ Flask truyền vào
        // LẤY dữ liệu từ HTML đã truyền từ Flask
        
        const line1 = document.body.dataset.line1 || "";
        const line2 = document.body.dataset.line2 || "";

        if (line1.trim()) fullText.push(line1);
        if (line2.trim()) fullText.push(line2);
...
console.log("📜 fullText = ", fullText);
        ...
        document.addEventListener('click', (e) => {
            if (document.getElementById('canvasPage')) {
    ...
    if (!musicPlayed) {
        ...
        // Tự động khởi động hiệu ứng khi trang load
